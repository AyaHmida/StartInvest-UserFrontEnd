                ...
                <form className="mt-sm-4" onSubmit={handleSumit}>
                  ...
                  <div className="mb-3 position-relative">
                    ...
                    <div className="input-group input-group-lg">
                      <input className="form-control fakepassword" type="password" id="psw-input" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Entrez votre nouveau mot de passe" />
