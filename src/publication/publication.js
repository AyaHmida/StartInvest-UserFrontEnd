...
></div>
              ...
              <div className="card card-body">
                <div className="d-flex mb-3">
                  ...
                  <form className="w-100">
                    <textarea className="form-control pe-4 border-0" rows="2" data-autoresize placeholder="Share your thoughts..." data-bs-toggle="modal" data-bs-target="#feedActionPhoto"></textarea>
                  </form>
                </div>
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="dropdown">
                      ...
                      <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="cardShareAction3">
                        ...
                        <li><a className="dropdown-item" href="#" onClick={() => handleDelete(publication.id)}> <i className="bi bi-slash-circle fa-fw pe-2"></i>Efface post</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex justify-content-between">
                    <div className="row g-3">
                      <div className="col-6">
                        <a className="h-100" href={baseURL + publication.file} data-glightbox data-gallery="image-popup">
                          <img className="rounded img-fluid" src={baseURL + publication.file}  alt="image"/>
                        </a>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="d-flex">
                        ...
                        <div className="ms-2">
                          <div className="bg-light rounded-start-top-0 p-3 rounded">
                            ...
                            <p className="small mb-0">Remod tedious ed projection.</p>
                          </div>
                ...
                <div className="card-header border-0 pb-0">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="cardShareAction5">
                      <li><a className="dropdown-item" href="#"> <i className="bi bi-slash-circle fa-fw pe-2"></i>Efface post</a></li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <div className="d-grid mt-3">
                        <a className="btn btn-sm btn-primary-soft" href="/profileConnection">View more</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div id="chatToast" className="toast mb-0 bg-mode" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
              <div className="toast-header bg-mode">
                <div className="d-flex justify-content-between align-items-center w-100">
                  ...
                  <div className="d-flex">
                    <div className="dropdown">
                      <a className="btn btn-secondary-soft-hover py-1 px-2" href="#" id="chatcoversationDropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"><i className="bi bi-three-dots-vertical"></i></a>
                      <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="chatcoversationDropdown">
                        <li><a className="dropdown-item" href="#"><i className="bi bi-camera-video me-2 fw-icon"></i>Video call</a></li>
                        <li><a className="dropdown-item" href="#"><i className="bi bi-telephone me-2 fw-icon"></i>Audio call</a></li>
                        <li><a className="dropdown-item" href="#"><i className="bi bi-trash me-2 fw-icon"></i>Delete </a></li>
                        <li><a className="dropdown-item" href="#"><i className="bi bi-chat-square-text me-2 fw-icon"></i>Mark as unread</a></li>
                        <li><a className="dropdown-item" href="#"><i className="bi bi-volume-up me-2 fw-icon"></i>Muted</a></li>
                        <li><a className="dropdown-item" href="#"><i className="bi bi-archive me-2 fw-icon"></i>Archive</a></li>
                        <li className="dropdown-divider"></li>
                        <li><a className="dropdown-item" href="#"><i className="bi bi-flag me-2 fw-icon"></i>Report</a></li>
                      </ul>
                    </div>
                    <a className="btn btn-secondary-soft-hover py-1 px-2" data-bs-toggle="collapse" href="#collapseChat" aria-expanded="false" aria-controls="collapseChat"><i className="bi bi-dash-lg"></i></a>
            ...
            <div id="chatToast2" className="toast mb-0 bg-mode" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
              <div className="toast-header bg-mode">
                <div className="d-flex justify-content-between align-items-center w-100">
                  ...
                  <div className="d-flex">
                    <div className="dropdown">
                      <a className="btn btn-secondary-soft-hover py-1 px-2" href="#" id="chatcoversationDropdown2" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"><i className="bi bi-three-dots-vertical"></i></a>
                    ...
                    <a className="btn btn-secondary-soft-hover py-1 px-2" data-bs-toggle="collapse" href="#collapseChat2" role="button" aria-expanded="false" aria-controls="collapseChat2"><i className="bi bi-dash-lg"></i></a>
                    <button className="btn btn-secondary-soft-hover py-1 px-2" data-bs-dismiss="toast" aria-label="Close"><i className="fa-solid fa-xmark"></i></button>
                  </div>
                </div>
      ...
      </div><div className="modal fade" id="modalCreateFeed" tabindex="-1" aria-labelledby="modalLabelCreateFeed" aria-hidden="true">
