          ...
          <div className="row">
            <div className="col-lg-8 mx-auto">
              <div className="card card-body">
                ...
                <div className="d-flex align-items-center justify-content-between my-3">
                  ...
                  <div className="dropdown">
                    ...
                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="cardFeedAction">
                      <li><a className="dropdown-item" href="#"> <i className="bi bi-x-circle fa-fw pe-2" />Delte this post</a></li>
                    </ul>
                  </div>
                ...
                <img className="card-img rounded" src="assets/images/post/16by9/big/01.jpg" alt />
                {/* Feed react START */}
                <ul className="nav nav-stack flex-wrap small mb-3">
                  <li className="nav-item">
                    <a className="nav-link" href="#!"> <i className="bi bi-hand-thumbs-up-fill pe-1" />(56)</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="#!"> <i className="bi bi-chat-fill pe-1" />(12)</a>
                  </li>
